...
public class Simulator {
    ...
    private static void displayEverything() {
        ...
        _appFrame.setSize(new Dimension(750, 750));
        ...
        contentPane.add(_buttons, BorderLayout.PAGE_START);
    ...
    private static void addButtons() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    loadMapButton.addMouseListener(new MouseAdapter() {
                        public void mousePressed(MouseEvent e) {
                            ...
                            loadMapFromDisk(realMap, loadTF.getText(), exploredMap);
                            CardLayout cl = ((CardLayout) _mapCards.getLayout());
                            cl.show(_mapCards, "REAL_MAP");
                            realMap.repaint();
                        }
        ...
        JButton btn_TimeExploration = new JButton("<html>Exploration<br>[ time limit ]</html>");
        ...
        JButton btn_CoverageExploration = new JButton("<html>Exploration<br>[ coverage limit ]</html>");
